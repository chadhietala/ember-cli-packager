...
This is a the packager which is exposed to developers in their Brocfile. It supersedes `EmberApp` and is encompasses the learnings from there. This pulls togeather the [Assembler](https://github.com/chadhietala/ember-cli-assembler) and the [Pre-Packager](ember-cli-pre-packager) to the file concat step.
